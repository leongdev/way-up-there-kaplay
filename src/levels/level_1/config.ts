...
export const levelConfig: CollisionObject = {
  ...
  colliders: [
    ...
    { x: 192, y: 192, width: 32, height: 16 },
    ...
    { x: 464, y: 32, width: 16, height: 224 },
    { x: 178, y: 32, width: 16, height: 160 },
    { x: 208, y: 208, width: 16, height: 64 },
    { x: 400, y: 106, width: 16, height: 48 },
